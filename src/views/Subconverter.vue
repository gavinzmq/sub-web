            ...
            >
              ...
              <el-form-item label="后端地址:">
                <el-select
                  ...
                  allow-create
                  filterable
                  placeholder="可输入自己搭建的后端服务。例 http://127.0.0.1:25500/sub?"
                  style="width: 100%"
                >
                  <el-option
                  ...
                  <el-collapse-item>
                    ...
                    <el-form-item label="包含节点:">
                      <el-input
                        ...
                        placeholder="要保留的节点关键字，支持正则"
                      />
                    </el-form-item>
                    <el-form-item label="排除节点 :">
                      <el-input
                        v-model="form.excludeRemarks"
                        placeholder="要排除节点名关键字，支持正则"
                      />
                    </el-form-item>
            ...
            options: [
              {
                label: "默认",
                value:
                  "https://raw.githubusercontent.com/Meilieage/webcdn/main/rule/Area_Media_NoAuto.ini",
              },
              {
                label: "默认（自动测速）",
                value:
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                ...
                value:
                  "https://raw.githubusercontent.com/WC-Dream/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full_Dream.ini",
              },
            ],
          },
          {
